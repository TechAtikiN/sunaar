        ...
        <div className='p-1 w-1/2'>
          ...
          <div className='w-full grid grid-cols-6 gap-x-4 gap-y-5 p-2'>
            ...
            <div className='col-span-3 flex flex-col space-y-2'>
              ...
              <input disabled defaultValue={'-'} type='text' className='dashboard-form-input text-sm p-2' />
            </div>
            ...
            <div className='col-span-6 flex flex-col space-y-2'>
              <label className='dashboard-form-label' htmlFor='address'>Order Remark</label>
              <textarea
